...
const menu=[
 ...
 ...masterNavigation.map(item=>({...item,section:item.href==="/tasks"?"OPERATIONS":["/intelligence/ota","/intelligence/yield","/intelligence/comp-set","/intelligence/marketing"].includes(item.href)?"PERFORMANCE":"MANAGEMENT"})),
];
