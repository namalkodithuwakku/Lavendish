...
export type NavigationIconName="hotel"|"group"|"ota"|"yield"|"compSet"|"marketing"|"properties"|"reputation"|"reports"|"settings"|"admin"|"tasks"|"more";
...
export function NavigationIcon({name}:{name:NavigationIconName}):ReactNode{
 const paths:Record<NavigationIconName,ReactNode>={
  ...
  compSet:<><path d="M4 19V9M10 19V5M16 19v-7M22 19H2"/><path d="m4 6 6-3 6 5 5-4"/></>,
  ...
  tasks:<><rect x="4" y="3" width="16" height="18" rx="2"/><path d="M9 8h7M9 12h7M9 16h5M7 8h.01M7 12h.01M7 16h.01"/></>,
...
export const masterNavigation=[
 ...
 {href:"/intelligence/comp-set",label:"Comp Set",icon:"compSet" as const},
