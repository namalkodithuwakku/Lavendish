...
export default function YieldClient(){
  ...
  const [hotel,setHotel]=useState("MLR"),[plans,setPlans]=useState<Plan[]>([]),[settings,setSettings]=useState<Settings|null>(null),[busy,setBusy]=useState(false),[notice,setNotice]=useState(""),[draft,setDraft]=useState<PlanDraft|null>(null),[copySource,setCopySource]=useState<Plan|null>(null),[confirmDelete,setConfirmDelete]=useState<Plan|null>(null);
  ...
  return <main className="admin-shell">
    ...
    <section className="admin-page yield-page">
      <header className="admin-header"><div><p>YIELD CONTROL</p><h1>Rates & notification rules</h1><span>All values are editable. Changes apply without changing application code.</span></div></header>
