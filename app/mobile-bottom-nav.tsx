...
export function MobileBottomNav() {
  ...
  const items: NavItem[] = [
    ...
    ...(master ? [
      { href: "/intelligence", label: "Overview", icon: <NavigationIcon name="overview"/>, active: (path: string) => path.startsWith("/intelligence") || path.startsWith("/properties") || path.startsWith("/reputation") || path.startsWith("/reports") || path.startsWith("/settings/intelligence") },
